...
interface IFileModelValue {
    code: string;
    language: string;
}

interface IFileModelConfig {
    lineWrapping: string;
    lineNumbers: string;
...
module App {
    ...
    class FileEditorController implements IFileController {
    ...
    app.controller("CodeMirror.FileController", FileEditorController);
}